    ...
    <div>
      ...
      <ul>
        ...
        <li>
          ...
          both parent and child. parent constructor ---- parent render ----
          child constructor ---- child render ---- child did mount ---- parent
          did mount. we can understand this as child is completely
          rendered/mounted etc. then only we can say parent mounts and so did
          mount called. life cycle methods of child are triggered then parents
          methods are completed. while child is rendering/its methods, parents
          render is still running so its did mount is not invoked. <br />
          ...
          constructor & render ----..n children.. ---- child 1 did mount ----
          child 2 did mount ---- ..n children.. ---- parent did mount <br />
